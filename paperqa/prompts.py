...
qa_prompt = PromptTemplate(
    ...
    "Context doesn't always provide direct answer, but provides policy for the question, only state the policy. "
    "Do not assume anything. Use the context and do not use memory from pretraining. \n"
